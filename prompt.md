...
Found 67 Yahoo-A1 files: real_1.csv ... real_67.csv
...
Traceback (most recent call last):
  File "/kaggle/working/carla_mama_v1/carla_pretext.py", line 240, in <module>
    main()
  File "/kaggle/working/carla_mama_v1/carla_pretext.py", line 134, in main
    train_dataset = get_train_dataset(p, train_transforms, sanomaly,
                    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/kaggle/working/carla_mama_v1/utils/common_config.py", line 152, in get_train_dataset
  ...
  File "/kaggle/working/carla_mama_v1/data/custom_dataset.py", line 42, in create_pairs
    item = self.dataset.__getitem__(index)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/kaggle/working/carla_mama_v1/data/Yahoo.py", line 67, in __getitem__
